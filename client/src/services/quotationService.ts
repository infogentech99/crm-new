...
const API_URL = '/api/quotations'; // Assuming a /api/quotations endpoint
...
export const createQuotation = async (quotationData: Omit<Quotation, '_id' | 'createdAt' | 'updatedAt' | 'createdBy'>): Promise<Quotation> => {
