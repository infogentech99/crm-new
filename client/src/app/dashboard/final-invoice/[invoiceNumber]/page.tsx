...
export default function FinalInvoicePage() {
  ...
  const id = params?.invoiceNumber as string;
    ...
    <div className="min-h-screen bg-gray-50 py-10">
      <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="p-3 border-r border-black leading-snug space-y-2">
              ...
              <div className="space-y-1">
                <p className="flex items-start">
                  ...
                  <span>Payment shall be made via Bank Transfer/Check/Online only.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>No direct UPI payments to employees.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>InfoGentech is not liable for personal account payments.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>3% late fee applies after 15 days on unpaid balances.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>Company may terminate services if payment is not made on time.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>Payment due within 5 days from the invoice date.</span>
                </p>
                <p className="flex items-start">
                  <span className="inline-block w-1 h-1 bg-black rounded-full mt-1 mr-2" />
                  <span>All disputes are subject to Delhi jurisdiction.</span>
                </p>
              </div>
            </div>
        ...
        <div className="flex justify-end space-x-4 print:hidden mt-4">
          <Button onClick={sendPDFEmail} disabled={sending}>
